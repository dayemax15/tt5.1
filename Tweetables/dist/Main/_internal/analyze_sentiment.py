...
sentiment_dict = {
    ...
    "breathtaking": 5, "phenomenal": 5, "spectacular": 5, "stunning": 5, "incredible": 5,
    "legendary": 5, "groundbreaking": 5, "emotionally-powerful": 5, "iconic": 5, "revolutionary": 5,
    "perfection": 5, "unforgettable": 5, "flawless": 5, "timeless": 5, "brilliantly-crafted": 5,
    ...
    "well-paced": 4, "immersive": 4, "emotional-journey": 4, "genius": 4, "peak-cinema": 5, "beautiful": 4,
    ...
    "fun-ride": 3, "touching": 3, "laugh-out-loud": 3, "witty": 3, "feel-good": 3,"love": 5, "excited": 4, "joy": 4, "funny": 4, "satisfying": 4, "enthusiastic": 4,
...
with open(os.path.join(base_path, "raw_tweets.txt"), "r", encoding="utf-8") as f:
...
# Save cleaned tweets
with open(os.path.join(base_path, "cleaned_tweets.txt"), "w", encoding="utf-8") as f:
    for line in cleaned_tweet_lines:
        f.write(line + "\n")

# Save analysis results
with open(os.path.join(base_path, "tweet_analysis_results.txt"), "w", encoding="utf-8") as f:
